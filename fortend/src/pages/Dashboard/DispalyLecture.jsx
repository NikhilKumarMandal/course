...
function DispalyLecture() {
  ...
  return (
    <Header>
  <div className="flex flex-col gap-10 items-center justify-center min-h-[90vh] py-10 text-white mx-auto max-w-screen-lg">
    ...
    {(lectures && lectures.length > 0) ? (
      <div className="flex flex-col sm:flex-row justify-center gap-10 w-full">
        ...
        <div className="w-full sm:w-[28rem] p-2 rounded-lg shadow-[0_0_10px_black]">
          <div className="video-container">
            <video
              src={lectures && lectures[currentVideo]?.avatar?.url}
              className="object-contain rounded-tl-lg rounded-tr-lg w-full h-full"
              controls
