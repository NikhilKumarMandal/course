...
function AdminDashboard() {
    ...
    const { usersCount, subscribedCount } = useSelector((state) => state.stat);
    ...
    const userData = {
      ...
      datasets: [
          {
              label: "User Details",
              data: [usersCount, subscribedCount],
  ...
  async function onCourseDelete(id) {
    ...
    console.log("NIKHIL",subscribedCount);
  return (
    <Header>
                        ...
                        <div className="grid grid-cols-2 gap-5">
                            <div className="flex items-center justify-between p-5 gap-5 rounded-md shadow-md">
                                <div className="flex flex-col items-center">
                                    ...
                                    <h3 className="text-4xl font-bold">{usersCount}</h3>
                                </div>
