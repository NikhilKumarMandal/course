...
function CourseDescription() {
  ...
  return (
    <Header>
    <div className="min-h-[90vh] pt-12 px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center text-white">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 py-10 relative max-w-screen-lg">
