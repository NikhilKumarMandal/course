...
function Signup() {
    ...
    const handleUserInput = (e) => {
        ...
        setSignupData({
          ...signupData,
          [name]: value || '' // Ensure a defined value is always set
      });
    }
  ...
  return (
    <Header>
        <div className='flex overflow-x-auto items-center justify-center h-[100vh]'>
                <form noValidate onSubmit={createUserAccount} className='flex flex-col justify-center gap-3 rounded-lg p-4 text-white w-96 shadow-[0_0_10px_black]'>
